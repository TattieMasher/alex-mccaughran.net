    ...
    <body>
        ...
        <main>
            <section id="intro">
				...
				<p class="fade-in-index-content_1">I am currently in my final year of Open University studying BSc (Honours) in Computing & IT (Software), with a predicted 1:1 classification. I have a deep passion for all things scientific and IT-related.</p>
